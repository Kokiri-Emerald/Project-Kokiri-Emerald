...
void EnMag_DrawInner(Actor* thisx, PlayState* play, Gfx** gfxp) {
    ...
    gDPSetEnvColor(gfx++, (s16)this->effectEnvColor[0], (s16)this->effectEnvColor[1], (s16)this->effectEnvColor[2],
                   255);
    // Commenting out this section removes title screen background flame effect
    ...
    if ((s16)this->mainAlpha != 0) {
        ...
        gDPPipeSync(gfx++);
        gDPSetPrimColor(gfx++, 0, 0, 0, 255, 0, (s16)this->mainAlpha);
    ...
    if (gSaveContext.fileNum == 0xFEDC) {
        ...
        // Actual Text
        gDPPipeSync(gfx++);
        gDPSetPrimColor(gfx++, 0, 0, 0, 255, 0, textAlpha);
        ...
        gDPSetCombineLERP(gfx++, 0, 0, 0, PRIMITIVE, TEXEL0, 0, PRIMITIVE, 0, 0, 0, 0, PRIMITIVE, TEXEL0, 0, PRIMITIVE,
                          0);
        gDPSetPrimColor(gfx++, 0, 0, 25.8, 69.8, 29.7, textAlpha);
        ...
        // Actual Text
        gDPPipeSync(gfx++);
        gDPSetPrimColor(gfx++, 0, 0, /*YREG(4)*/0, /*YREG(5)*/255, /*YREG(6)*/0, textAlpha);
